...
def read_command_line():
    ...
    parser.add_argument('--case', type=str, required=True, default="simulation/results_folder/model/data/1/Solutions",
                        help="Path to simulation results", metavar="PATH")
    parser.add_argument('--nu', type=float, default=0.04,
                        help="Kinematic viscosity used in simulation")
    parser.add_argument('--rho', type=float, default=1.06,
                        help="Fluid density used in simulation")
    parser.add_argument('--dt', type=float, required=True, help="Time step for the simulation, measured in [s]")
